...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Hero Class</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see hearthstone.HearthstonePackage#getHeroClass()
 * @model
 * @generated
 */
public enum HeroClass implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Hero Class</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final HeroClass[] VALUES_ARRAY =
		new HeroClass[] {
			MAGE,
			PRIEST,
			PALADIN,
	...
	/**
	 * A public read-only list of all the '<em><b>Hero Class</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<HeroClass> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Hero Class</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static HeroClass get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			HeroClass result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Hero Class</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Hero Class</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static HeroClass get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private HeroClass(int value, String name, String literal) {
		this.value = value;
		this.name = name;
